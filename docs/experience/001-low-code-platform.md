...
company: "МРС · B2B SaaS платформа"
title: "Tech Lead / Architect"
cv_description: "Ключевой технический decision-maker B2B SaaS платформы: 10+ сервисов, 4–6 продуктов, 30–60 enterprise-клиентов (в т.ч. Полюс, Мосинжпроект). Команда 7–13 чел. Внедрил Kotlin Multiplatform: весь бизнес-слой и мультитенантная инфраструктура вынесены в общие библиотеки JVM/JS — клиентские приложения отвечают только за UI. Новые сервисы на Ktor + Exposed: старт 3–5 с вместо 25–30 с и ~130 МБ памяти вместо ~225 МБ у Spring Boot + Hibernate. Возглавлял R&D-направление (KMP, QUIC/HTTP-3, AI-инструменты)."
---
